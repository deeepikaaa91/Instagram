...
function Userpage() {
  ...
  return (
    <div className="flex">
      ...
      {/* ----------------------------------------------Remove------------------------------*/}
      {showDiv && (
        <div className="w-[100%] flex items-center justify-center h-[100vh] bg-black fixed opacity-80">
          <div
            onClick={() => setShowDiv(false)}
            className="w-[100%] flex items-center justify-center h-[100vh]"
          >
            <h1
              onClick={() => setShowDiv(false)}
            ...
            <div className="flex flex-col items-center  h-[49vh] w-[30%]  bg-white rounded-xl">
